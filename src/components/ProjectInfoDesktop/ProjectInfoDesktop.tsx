  ...
  return (
    ...
    >
      ...
      <section className="w-[80%] h-full absolute flex flex-col justify-evenly items-end top-0 right-0">
        <h2 className="w-[60%] font-bold text-3xl text-center">{project.name}</h2>
        <p className="w-[70%] text-justify text-xl pl-[4%] pr-3 indent-[10%]"> {t(project.name.toLowerCase())}</p>
        ...
        <section className="w-[90%]">
          <h3 className="text-center text-2xl font-bold mb-5"> {t("technologies")} </h3>

...
import { SiTailwindcss, SiDocker, SiFramer, SiReactrouter, SiVite, SiFigma, SiPostman } from "react-icons/si";
...
const OtherSkills = () => {
    ...
    return(
        <section className="w-full mt-16 flex flex-col items-center">
            <h2 className="text-2xl font-bold text-center lg:text-4xl">{t('other')}</h2>
            <motion.section 
            ref={ref}
